 ...
 */
public class Niveau3 extends SideMenuBaseForm {

    CoursServices cs = new CoursServices();

    public Niveau3(Resources res) {
       ...
       Container All = new Container(BoxLayout.y());
        ...
        ImageViewer cat = new ImageViewer(theme.getImage("cat.jpg"));
        Container title = new Container(BoxLayout.y());
        Label etatrep = new Label("Trouver ce");
        Label chat = new Label("chat");
        title.add(etatrep);
        title.add(chat);
        
        chat.addPointerPressedListener(l -> {
         correctS.play();
            cs.NiveauSuivant(4);
