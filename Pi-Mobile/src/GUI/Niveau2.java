 ...
 */
public class Niveau2 extends SideMenuBaseForm {

    CoursServices cs = new CoursServices();

    public Niveau2(Resources res) {
       ...
       Button menuButton = new Button();
        ...
        ImageViewer time = new ImageViewer(theme.getImage("echo.jpg"));
        TextField reponse = new TextField();
        reponse.setUIID("TextField1");
        Label etatrep = new Label("");
        Button valider = new Button("Valider");

        valider.addActionListener(l -> {

            if (reponse.getText().toLowerCase().equals("echo")) {
                correctS.play();
                cs.NiveauSuivant(3);
